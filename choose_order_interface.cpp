...
void choose_order0()
{
	...
	drawtext(_T("请选择先后手："), &r, DT_CENTER | DT_VCENTER | DT_SINGLELINE);
	...
	drawtext(_T("先手"), &r1, DT_CENTER | DT_VCENTER | DT_SINGLELINE);
	RECT r2 = { 420, 410, 560, 450 };
	drawtext(_T("后手"), &r2, DT_CENTER | DT_VCENTER | DT_SINGLELINE);
}